...
//     assert(modifyResult == StatusCode::Success);
//
...
//     std::cout << "\nModifying buy order to $110 (should match)..." <<
//     std::endl; engine.ModifyOrder(buyResult.orderId, 15, 110);
//
...
//     assert(result == StatusCode::OrderNotFound);
//
...
//     assert(modifyResult == StatusCode::OrderNotFound);
